...
# Phrase unique to lego task instructions — used to detect lego items so that
# src_latents are preserved (not silenced) inside the repaint zone, giving the
# DiT full harmonic/rhythmic context from the source audio.
